...
class IPhone extends SmartPhone {
    ...
    constructor(seriesName, ram, batteryPower, price) {
      ...
      remainingAmount(priceIHave){
        let phonePrice = this.price
        this.price = priceIHave - this.price
        return priceIHave<phonePrice ? `Customer can't able to buy a phone due to insufficient amount` : this.price <=0 ? "Customer has no more amount" : 'Customer has remaining Rs.'+this.price +' after buying an iphone';
